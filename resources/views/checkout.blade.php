                       ...
                       <div id="collapseThree" class="panel-collapse collapse">
                         <div class="panel-body">
                           ...
                           <div class="row">
                             <div class="col-md-6">
                               <div class="aa-checkout-single-bill">
                                 <input type="text" name="suit_Appartment" placeholder="Appartment, Suite etc.">
                               </div>                             
                             </div>
                             <div class="col-md-6">
                               <div class="aa-checkout-single-bill">
                     ...
                     <table class="table table-responsive">
                       ...
                       <tbody>
                        ...
                        {{-- <li class="mb-3 border-bottom pb-3 d-flex">
                            <span class="mr-auto"> {{ $details['quantity'] }} x  <a href="{{route('product',$details['slug'])}}" > {{ $details['title'] }}  </a>   </span> 
                            <span class="px-3" >${{$lineTotal}}</span>
                        </li> --}}
                        <tr>
                        <td>{{ $details['title'] }} {{$details['price']}}<strong> x &nbsp; {{ $details['quantity'] }}</strong></td>
                          <td>{{$lineTotal}}</td>
                        <input type="hidden" name="line_total" value="{{$details['price']}}">
                        </tr>
                        @endforeach
                       </tbody>
                       <tfoot>
                         <tr>
                          ...
                          <td name="total_cost">{{$totalCost}}</td>
                         </tr>
                       </tfoot>
                     </table>
                   </div>
